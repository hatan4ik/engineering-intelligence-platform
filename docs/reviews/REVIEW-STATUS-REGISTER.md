...
| Shared Company Brain contracts | **Resolved in source.** PR Guardian is the demonstrated first consumer, now with bounded context, evidence-read, human-correction, why-evaluation, and recoverable-publication contracts; reuse by a second product and managed-runtime proof remain future evidence. | [Company Brain Core](../COMPANY-BRAIN-CORE.md), [Decision Experience](../COMPANY-BRAIN-DECISION-EXPERIENCE.md) |
