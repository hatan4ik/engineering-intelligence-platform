...
| Architect | [System Design](../architecture/design.md) → [NFRs](../architecture/non-functional-requirements.md) → [ADRs](../architecture/adr/README.md) → [Capability Reconciliation](../architecture/CAPABILITY-RECONCILIATION.md) | What constraints govern a design change, and which portions are reference versus target state? |
...
| SRE or security reviewer | [Production Evidence](PRODUCTION-EVIDENCE.md) → [Production Readiness](PRODUCTION-READINESS.md) → [Threat Model](../governance/security-threat-model.md) → relevant L3/L4 runbook | What proof is required before real data, automation, or autonomy is allowed? |
...
| Architecture decisions | [ADR index](../architecture/adr/README.md) · [Temporal control plane](../architecture/adr/001-temporal-control-plane.md) · [Prompt injection and caching](../architecture/adr/002-prompt-injection-and-caching.md) · [Company Brain runtime topology](../architecture/adr/003-company-brain-runtime-topology-and-recovery.md) |
...
| Autonomy progression | [L3 Rehearsal](L3-REHEARSAL-RUNBOOK.md) · [L4 Promotion](L4-PROMOTION-RUNBOOK.md) · [Production Readiness](PRODUCTION-READINESS.md) |
