...
class DurableSelfHealingCoordinator:
    """Durable L3 execution coordinator.

    A plan is persisted and hash-bound before approval. Only a cryptographically
    verified Approval can enqueue the mutation job. The queue can retry after a
    process restart without re-authorizing a different plan.
    """
